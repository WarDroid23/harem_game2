...
data class PartyMember(
    ...
    val loyaltyValue: Int = 50,
    val loyaltyCombatBonusDmg: Float = 1.0f,
    val loyaltyCombatBonusDef: Float = 1.0f,
    val loyaltyCombatBonusCrit: Int = 0,
    val loyaltyAssistChancePercent: Int = 0,
    val loyaltyProtectLordChancePercent: Int = 0,
