...
with open('app/src/main/java/com/example/haremdark/ui/screens/WorldMapScreen.kt', 'r') as f:
    text = f.read()
...
with open('app/src/main/java/com/example/haremdark/ui/screens/WorldMapScreen.kt', 'w') as f:
    f.write(text)
